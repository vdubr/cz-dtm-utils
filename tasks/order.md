...
| 2 | **ciselnik-popisky** — textové popisky číselníkových atributů v panelu prvku (kód → význam dle číselníku DTM) | 🔄 IN PROGRESS | [`ciselnik-popisky/README.md`](./ciselnik-popisky/README.md) · [úkoly](./ciselnik-popisky/TASKS.md) |
...
| 5 | **barvy-siti-legenda** — soulad barev sítí v legendě/panelu s mapou (reprezentativní barva z variant), oprava 27 poškozených výplní (RGB→fillColor), audit vs. Katalog DTM (kanalizace vs. teplovod) | ⬜ TODO | [README](./barvy-siti-legenda/README.md) · [úkoly](./barvy-siti-legenda/TASKS.md) |
