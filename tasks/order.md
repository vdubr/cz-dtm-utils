...
| # | Zadání | Stav | Spec |
|---|--------|------|------|
| 1 | **jvf version** — podpora JVF DTM 1.5.0.1 souběžně s 1.4.3 (parser + topologie + viewer) | 🔄 IN PROGRESS | [`jvf version/README.md`](./jvf%20version/README.md) · [úkoly](./jvf%20version/TASKS.md) |
